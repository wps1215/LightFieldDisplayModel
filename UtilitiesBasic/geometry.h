#ifndef UTILITIESBASIC_GEOMETRY_H
#define UTILITIESBASIC_GEOMETRY_H
...
template <typename T> struct vec<3,T> {
    ...
    vec(T X, T Y, T Z) noexcept : x(X), y(Y), z(Z) {}
...
template <typename T> struct vec<4,T> {
    ...
    vec(T X, T Y, T Z, T W) noexcept : x(X), y(Y), z(Z), w(W) {}
...
#endif // UTILITIESBASIC_GEOMETRY_H
